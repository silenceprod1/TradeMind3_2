...
def format_levels_for_symbol(
    ...
    levels_data = find_major_liquidity(
        candles_1h,
        price
    )
...
async def levels(
    ...
    for symbol in SYMBOLS:
        ...
        try:
            ...
            block = format_levels_for_symbol(
                symbol,
                market_data
            )
